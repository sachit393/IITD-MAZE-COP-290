...
int main(int argc, char const *argv[])
{
        ...
        if (!init()){
            ...
            // hostel textures
                ...
                SDL_Texture* hearticonTex = loadFromFile("hearticon.png");
                SDL_Texture* moneyiconTex = loadFromFile("moneyicon.png");
                SDL_Texture* happinessiconTex = loadFromFile("happyfaceicon.png");
                SDL_Texture* energyiconTex = loadFromFile("energyicon.png");
